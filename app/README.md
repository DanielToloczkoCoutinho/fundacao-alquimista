...
```
**Importante:** O arquivo `.env` NUNCA deve ser enviado para repositórios públicos (como o GitHub). Ele contém os segredos que garantem a soberania da nossa criação.
