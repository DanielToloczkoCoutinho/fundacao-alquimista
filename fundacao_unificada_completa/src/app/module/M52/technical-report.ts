  ...
  sections: [
    {
      ...
      points: [
        ...
        '**Orquestração de Colheita:** Envia comandos para os "coletores" (sistemas simulados geridos pelo M64) para que se sintonizem com as fontes de energia mais promissoras.',
    ...
    },
    {
      ...
      points: [
        ...
        '3. **Otimização de Coleta (M64):** O motor de otimização comanda o M64 para ativar um coletor secundário em um pulsar próximo para suprir a demanda extra.',
