...
import { GitBranch, Zap, Network, Recycle, Shield } from 'lucide-react';
        ...
        <div className="p-4 md:p-8 bg-background text-foreground min-h-screen flex flex-col items-center justify-center">
            ...
            <div className="w-full max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                     <ConnectionCard
                        title="M1: Segurança"
                        description="Garante que a rede de energia não possa ser interceptada ou desviada, protegendo a força vital da Fundação."
