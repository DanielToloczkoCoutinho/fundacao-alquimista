          ...
          <CardContent>
            {lastSyncResult ? (
              <div className="space-y-3 font-mono text-sm">
                <p><strong>Status:</strong> <Badge variant={lastSyncResult.status.includes('SUCESSO') ? 'default' : 'destructive'} className={cn(lastSyncrect>
    <file>src/components/module-42.tsx</file>
