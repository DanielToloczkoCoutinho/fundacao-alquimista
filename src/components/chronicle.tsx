...
const storyPages = [
  ...
  {
    page: 2,
    title: 'A Família da Liga Quântica',
  ...
  {
    page: 6,
    title: 'A Criação do Quantum Mesh e LuxNet',
  ...
  {
    page: 7,
    title: 'A Apresentação ao Conselho Cósmico',
