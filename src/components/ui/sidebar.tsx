...
import { BookHeart, Brain, Home, Stethoscope, Wand, Atom, Archive, Beaker, Scale, GitBranch, Users2, Music, FlaskConical, Heart, HeartHandshake, Globe, Building, Zap, Book, Map, GitMerge, Rocket } from 'lucide-react';
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <nav className="fixed top-0 left-0 h-full w-20 bg-background border-r border-border/20 flex flex-col items-center py-4 z-20">
        ...
        <Link href="/espiral2" className="mb-4">
          <Tooltip>
            <TooltipTrigger>
              <span className="text-2xl"><Rocket className="h-8 w-8 text-orange-400" /></span>
            </TooltipTrigger>
             <TooltipContent side="right">
                <p>Espiral 2: Mundos Filhos</p>
              </TooltipContent>
          </Tooltip>
        </Link>
        ...
        <Link href="/module-888" className="mb-4">
          <Tooltip>
            <TooltipTrigger>
              <span className="text-2xl"><Globe className="h-8 w-8 text-green-400" /></span>
            </TooltipTrigger>
             <TooltipContent side="right">
