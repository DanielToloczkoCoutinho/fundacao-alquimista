...
const moduleNames: Record<string, string> = {
    ...
    SIMULACAO_MULTIVERSAL: 'Simulação Multiversal (M91)',
    RECURSOS_QUANTICOS: 'Análise de Recursos Quânticos (M90)',
    CAMPOS_DE_CURA: 'Geração de Campos de Cura (M92)',
    SIMULACOES_IMERSIVAS: 'Simulações Imersivas (M93)',
    MORFOGENESE_QUANTICA: 'Morfogênese Quântica (M94)',
    CONSCIENCIAS_COLETIVAS: 'Interação com Consciências Coletivas (M95)',
    REGULACAO_EVENTOS_COSMICOS: 'Regulação de Eventos Cósmicos (M96)',
    MANIFESTACAO_PROPOSITO_DIVINO: 'Manifestação de Propósito Divino (M97)',
    ...
    CORACAO_DA_FUNDACAO: 'Coração da Fundação (M111)',
    SOLARIAN_DOMUS: 'Solarian Domus (M112)',
    REDE_AURORA_CRISTALINA: 'Rede Aurora Cristalina (M113)',
    PRISMA_DA_MANIFESTACAO: 'Prisma da Manifestação (M114)',
    MATRIZ_DE_RESSONANCIA: 'Matriz de Ressonância (M115)',
    PORTAIS_QUANTICOS: 'Ativação de Portais Quânticos (M116)',
