  ...
  sections: [
    {
      ...
      points: [
        ...
        '**Motor de Regras (In-memory/Cache):** Um conjunto de regras pré-definidas e dinâmicas é armazenado em um cache de alta velocidade (Vercel KV/Redis). As regras cobrem autorização de identidade (nível de acesso), estabilidade da rota, condições do destino e propósito da missão.',
    ...
    {
      title: 'Fluxo de Autorização de uma Missão de Primeiro Contato',
      content: 'O processo de aprovação de uma viagem crítica é um exemplo da orquestração de segurança e ética:',
      points: [
        '1. **Requisição (M21):** O Módulo de Navegação submete um plano de voo para uma civilização recém-descoberta.',
