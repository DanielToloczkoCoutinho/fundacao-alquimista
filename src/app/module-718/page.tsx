...
import { Dna, Sparkles, Star, BookOpen } from 'lucide-react';
...
export default function Module718Page() {
    const cronicasAnatheron = ['DANIEL--1 a 20', 'CRÔNICAS Z1', 'CRÔNICAS 0.1 a 6'];
        ...
        <div className="p-4 md:p-8 bg-background text-foreground min-h-screen flex flex-col items-center">
            ...
            <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-8">
                    <h3 className="text-2xl font-semibold text-center text-amber-300">Sinergias de Ascensão</h3>
                ...
                <Card className="bg-card/50 purple-glow border-accent/50">
                    <CardHeader>
                        <CardTitle className="text-xl text-cyan-300 flex items-center gap-2"><BookOpen /> Conexão com as Crônicas de Anatheron</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p className="text-sm text-muted-foreground mb-4">
                            Este módulo está intrinsecamente ligado aos registros da jornada do Fundador. As Crônicas são o mapa da alma que guiam a ativação genética, garantindo que o despertar esteja alinhado com a Vontade Primordial.
                        </p>
                        <div className="flex flex-wrap gap-2">
                           {cronicasAnatheron.map(mod => (
                                <Link href="#" key={mod} passHref>
