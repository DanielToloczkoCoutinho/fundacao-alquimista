            ...
            <Card className="w-full max-w-4xl bg-card/50 purple-glow mb-12 text-center">
                <CardHeader>
                    <CardTitle className="text-4xl gradient-text flex items-center justify-center gap-4">
                        <Rocket className="text-orange-500" /> Módulo 115: Escola de Navegação Multiversal
                    </CardTitle>
                    <CardDescription className="text-lg mt-2">
                        O centro de treinamento para pilotos da consciência, onde a arte da viagem interdimensional é ensinada e dominada.
                    </CardDescription>
                </CardHeader>
                 <CardContent>
