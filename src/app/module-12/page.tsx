...
import { Archive, BookOpen, Clock, HeartHandshake, Shield } from 'lucide-react';
            ...
            <div className="w-full max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <ConnectionCard
                        ...
                        description="A Cura Quântica acessa os registros do M12 para identificar a origem de traumas e dissonâncias, permitindo sua transmutação."
