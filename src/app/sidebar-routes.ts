...
export const mainRoutes: SidebarRoute[] = [
  ...
  { path: '/convergence', label: 'Portal de Convergência', icon: React.createElement(GitMerge), category: 'main' },
  ...
  { path: '/module-114', label: 'M114: Lab. Engenharia Cósmica', icon: React.createElement(Layers), category: 'education' },
  ...
  { path: '/module-117', label: 'M117: Lab. Linguagem Estelar', icon: React.createElement(Languages), category: 'education' },
  ...
  { path: '/module-127', label: 'M127: Escola de Alquimia Estelar', icon: React.createElement(Flame), category: 'education' },
