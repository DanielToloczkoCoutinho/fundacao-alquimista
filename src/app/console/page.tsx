        ...
        <div className="space-y-6">
          <Card className="bg-card/50 purple-glow">
            ...
            <CardContent className="flex flex-col space-y-2">
              ...
              <Button variant="outline" asChild className="justify-start">
                <Link href="/module-201"><Heart className="mr-2 h-4 w-4" />Módulo 201 (Morada Eterna)</Link>
              </Button>
              <Button variant="outline" asChild className="justify-start">
              ...
              <Button variant="outline" asChild className="justify-start">
                <Link href="/module-306"><GitFork className="mr-2 h-4 w-4" />Módulo 306 (Sincronização de Linha Temporal)</Link>
              </Button>
              <Button variant="outline" asChild className="justify-start">
                <Link href="/module-307"><Zap className="mr-2 h-4 w-4" />Módulo 307 (Energia do Ponto Zero)</Link>
              </Button>
              <Button variant="outline" asChild className="justify-start">
