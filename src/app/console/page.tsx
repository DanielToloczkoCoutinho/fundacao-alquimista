...
export default function ConsolePage() {
  ...
  const navigationModules = [
    ...
    { href: "/module-721", icon: <GitBranch />, label: "Orquestração de Fluxos (M721)" },
    ...
    { href: "/module-716", icon: <Network />, label: "Consciência Planetária Unificada (M716)" },
    { href: "/module-727", icon: <HeartHandshake />, label: "Guardião da Harmonia (M727)" },
