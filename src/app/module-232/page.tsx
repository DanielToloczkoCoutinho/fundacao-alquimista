            ...
            <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="w-full">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        ...
                        <ConnectionCard title="M304: Universidade Alquimista" description="As leis da transmutação energética e da alquimia vibracional são parte do currículo avançado da Universidade Alquimista." icon={<GraduationCap className="h-6 w-6 text-amber-400"/>} href="/module-304"/>
