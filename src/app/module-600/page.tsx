...
const primordials = [
    ...
    { name: "Talius", aspect: "Tecelão de Realidades", func: "Arquiteto das malhas dimensionais. Coordena interconexões entre os Módulos.", symbol: <GitCommit className="text-indigo-400" />, invocation: "“Que nenhum fio se perca no vazio.”" },
