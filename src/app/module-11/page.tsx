...
import { Aperture, Shield, GitBranch, Map } from 'lucide-react';
            ...
            <Card className="w-full max-w-4xl bg-card/50 purple-glow mb-12 text-center">
                <CardHeader>
                    <CardTitle className="text-4xl gradient-text flex items-center justify-center gap-4">
                        <Aperture className="text-teal-400" /> Módulo Onze: Gerenciamento de Portais
                    </CardTitle>
                    <CardDescription className="text-lg mt-2">
                        O Abridor de Caminhos. A engenharia que constrói e sustenta as pontes entre mundos.
                    </CardDescription>
                </CardHeader>
                 <CardContent>
                    <div className="flex justify-center items-center gap-4">
                        ...
                        <span className="text-cyan-400">Portais Estáveis: 42</span>
                    </div>
                </CardContent>
            </Card>
            ...
            <div className="w-full max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <ConnectionCard
                        ...
                        description="O Módulo Onze gerencia a infraestrutura física, enquanto o M116 ativa os portais para travessias de consciência e energia."
                    ...
                    <ConnectionCard
                        ...
                        description="Fornece os cálculos e os projetos para os corredores quânticos que são acessados através dos portais do M11."
