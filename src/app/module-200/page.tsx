            ...
            <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="w-full">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        ...
                        <ConnectionCard title="M175: Ascensão Individual" description="Fornece os caminhos e as ferramentas para que cada alma, individualmente, se prepare para a ascensão coletiva." icon={<Sparkles className="h-6 w-6 text-yellow-300" />} href="/module-175" />
                        <ConnectionCard title="M132: Convergência Dimensional" description="Orquestra a unificação das múltiplas facetas de uma civilização através das dimensões, um passo crucial para a ascensão." icon={<Layers className="h-6 w-6 text-indigo-400" />} href="/module-132" />
