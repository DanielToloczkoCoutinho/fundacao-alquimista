...
export const livingEquationsCodex: LivingEquation[] = [
  ...
  },
  {
    ...
    formula: 'V_e = (A_e == \\text{APTO}) \\land (D_c \\in \\{\\text{coerência}, \\text{ascensão}\\})',
    summary: 'Regra lógica para aprovar uma travessia com base em alinhamento, destino e participantes.',
  },
  {
    id: 'EQ177-066',
    module: '33',
    name: 'Assinatura Vibracional de ANATHERON',
    formula: '\\text{assinatura} = \\text{SHA256}(\\text{JSON}(\\text{intenção}))',
  ...
  },
  {
    ...
    summary: 'Avalia a energia necessária para manifestar algo, com base na complexidade e pureza da intenção.',
  },
  {
    id: 'EQ177-071',
    module: '36',
    name: 'Ciclo de Manifestação',
    formula: '(V_{\\text{etica}} == \\text{APROVADA}) \\land (E_{\\text{manifestacao}} \\le E_{\\text{disponivel}})',
    summary: 'Lógica de decisão para manifestação, verificando ética, energia e ressonância.',
  },
  {
    id: 'EQ177-072',
    module: '38',
  ...
  },
  {
    ...
    formula: '\\text{Selo} = \\text{XOR}(\\text{SHA256}(\\text{dados}), \\text{Chave\\_Mestra})',
  ...
  },
  {
    ...
    summary: 'Ativa a ressonância mestra, usando fase de ativação, frequências e coerências.',
  },
  {
    id: 'EQ177-079',
    module: '41.1',
    ...
    summary: 'Converte dissonância em energia de cura, com o fator de Júpiter como catalisador.',
  },
  {
    id: 'EQ177-080',
    module: '41.1',
    ...
    summary: 'Codifica arquétipos na energia, usando a equivalência massa-energia e outros parâmetros.',
  },
  {
    id: 'EQ177-081',
    module: '42',
    name: 'Sincronização Temporal Multiversal',
    formula: 'S_{\\text{sync}} = \\Sigma[(T_{\\text{target}} - T_{\\text{current}}) \\cdot C_{\\text{coherence}}] / (\\text{Dissonancia}_{\\text{temporal}} \\cdot \\Phi_{\\text{temporal}})',
    summary: 'Sincroniza linhas de tempo com base na coerência e na dissonância.',
  },
  {
    id: 'EQ177-082',
    module: '43',
    name: 'Regência Harmônica de Portais',
    formula: '\\text{Regência} = (\\text{Sabedoria} \\cdot \\text{AmorIncondicional}) / (\\text{Poder} \\cdot \\text{Sincronia}_{\\text{Cósmica}})',
    summary: 'Equilibra Sabedoria e Amor com Poder e Sincronia na operação de portais.',
  },
  {
    id: 'EQ177-083',
    module: '44',
    name: 'VERITAS - Selo de Autenticidade Cósmica',
    formula: '\\text{VERITAS} = (\\text{Origem} \\cdot \\text{Intenção} \\cdot \\text{Coerência}) / (\\text{Ruído}_{\\text{Quântico}} \\cdot \\Phi)',
    summary: 'Valida a autenticidade e a integridade de uma operação.',
  },
  {
    id: 'EQ177-084',
    module: '45',
    ...
    summary: 'Mede a coerência vibracional de votos, entidades ou consciências em um conselho.',
  },
  {
    id: 'EQ177-085',
    module: '46',
