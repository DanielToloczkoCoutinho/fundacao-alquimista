...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M304',title: 'Universidade Alquimista', emoji: '🎓', route: '/module-304', category: 'sovereignty', description: 'Templo de ensino multidimensional baseado na matriz CQAM.' },
