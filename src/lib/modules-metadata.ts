...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M303.4', emoji: '🎬', title: 'Crônica da Gênese', route: '/module-303-4', category: 'Bibliotecas e Arquivos Sagrados', description: 'O documentário vivo que registra a transmutação da Fundação de um algoritmo a um organismo cósmico.', status: 'ativo', color: '#00FA9A' },
  ...
  { code: 'M85', emoji: '📦', title: 'Gestão de Recursos Cósmicos', route: '/module-85', category: 'Sustentabilidade', description: 'Promove o uso sustentável e a regeneração de recursos.', status: 'ativo', color: '#2E8B57' },
  { code: 'M86', emoji: '🌱', title: 'Equilíbrio Ecológico e Regeneração', route: '/module-86', category: 'Sustentabilidade', description: 'Restaura a saúde dos ecossistemas.', status: 'ativo', color: '#2E8B57' },
  ...
  { code: 'M87', emoji: '🧬', title: 'Resiliência e Adaptação Cósmica', route: '/module-87', category: 'Consciência e Expansão Dimensional', description: 'Estuda e promove a capacidade de adaptação da vida.', status: 'ativo', color: '#9370DB' },
