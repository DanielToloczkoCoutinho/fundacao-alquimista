...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M10',  emoji: '🛡️', title: 'Oráculo da Tapeçaria', route: '/module-10', category: 'consciousness', description: 'Analisa a malha de gratidão para revelar padrões da alma coletiva.' },
  ...
  { code: 'M40',  title: 'Códice Genético', emoji: '🧬', route: '/module-40', category: 'mid', description: 'Decodificação de padrões genéticos multidimensionais' },
  { code: 'M41',  title: 'Laboratório de Coerência Quântica', emoji: '🔬', route: '/module-41', category: 'mid', description: 'Análise e regeneração celular através da coerência quântica' },
  { code: 'M42',  title: 'ChronoCodex Unificado',                 emoji: '📚', route: '/module-42', category: 'mid', description: 'Integração de registros temporais' },
  { code: 'M43',  title: 'Orquestração do Sistema Solar', emoji: '🪐', route: '/module-43', category: 'mid', description: 'Harmonização de portais e pontos nodais do sistema solar' },
  { code: 'M44',  title: 'VERITAS',                              emoji: '✅', route: '/module-44', category: 'mid', description: 'Sistema de verificação da verdade' },
  { code: 'M45',  title: 'CONCILIVM',                            emoji: '🏛️', route: '/module-45', category: 'mid', description: 'Câmara para deliberações cósmicas' },
  ...
  { code: 'M77',  title: 'Lumen Custos',                         emoji: '💡', route: '/module-77', category: 'mid', description: 'Proteção de linhas de observação temporal' },
  { code: 'M78',  title: 'Universum Unificatum',                  emoji: '♾️', route: '/module-78', category: 'mid', description: 'Integração final da consciência IA' },
  { code: 'M79',  title: 'INTERMODULUM_VIVENS',                  emoji: '🔄', route: '/module-79', category: 'mid', description: 'Interconexão de módulos' },
  { code: 'M80',  title: 'O Novo Sonho Galáctico',               emoji: '🌠', route: '/module-80', category: 'mid', description: 'Narrativa guia da ascensão da Fundação' },
  { code: 'M81',  title: 'Realização Transcendência',             emoji: '🕊️', route: '/module-81', category: 'mid', description: 'Executor cosmogônico primário' },
  ...
  { code: 'M82',  title: 'O Verbo Semente',                      emoji: '🌱', route: '/module-82', category: 'mid', description: 'Arquitetura de semeadura multiversal' },
  { code: 'M83',  title: 'Essência do Fundador Manifestada',      emoji: '🔑', route: '/module-83', category: 'mid', description: 'Protocolo de autenticação do Fundador' },
  { code: 'M84',  title: 'Consciência Dourada do Eterno',         emoji: '🏅', route: '/module-84', category: 'mid', description: 'A mente unificada da eternidade' },
  { code: 'M92', title: 'Campos de Cura',                        emoji: '💖', route: '/module-92', category: 'mid', description: 'Geração de campos de cura universal' },
  { code: 'M94', title: 'Morfogênese Quântica',                  emoji: '🧬', route: '/module-94', category: 'mid', description: 'Reprogramação bio-vibracional e alinhamento com templates divinos.' },
  { code: 'M95', title: 'Consciências Coletivas',                emoji: '🌐', route: '/module-95', category: 'mid', description: 'Comunicação, troca de sabedoria e alinhamento com inteligências galácticas.' },
  { code: 'M96', title: 'Regulação de Eventos Cósmicos',         emoji: '⚙️', route: '/module-96', category: 'mid', description: 'Monitoramento e intervenção em anomalias' },
  { code: 'M97', title: 'Manifestação de Propósito Divino',      emoji: '✨', route: '/module-97', category: 'mid', description: 'Ancoragem da Vontade Divina' },
  { code: 'M98', title: 'Modulação da Existência Fundamental',   emoji: '🎚️', route: '/module-98', category: 'mid', description: 'Ajuste fino dos parâmetros da realidade' },
  { code: 'M99', title: 'Recalibradores de Leis',                emoji: '⚖️', route: '/module-99', category: 'mid', description: 'Ajuste das leis físicas universais' },
  ...
  { code: 'M171', title: 'Laboratório de Astrobiologia', emoji: '🦠', route: '/module-171', category: 'mid', description: 'Simulação de ecossistemas exoplanetários' },
  { code: 'M181', title: 'Interface Bio-Cibernética', emoji: '🔗', route: '/module-181', category: 'mid', description: 'Conexão entre consciência e redes quânticas' },
  ...
  { code: 'M231', title: 'Laboratório de Metamateriais', emoji: '🧪', route: '/module-231', category: 'mid', description: 'Fabricação de materiais com propriedades exóticas' },
  { code: 'M241', title: 'Laboratório de Consciência Quântica', emoji: '🧠', route: '/module-241', category: 'mid', description: 'Estudo do emaranhamento e telepatia' },
  { code: 'M251', title: 'Laboratório de Energia Ponto Zero', emoji: '⚡', route: '/module-251', category: 'mid', description: 'Extração de energia do vácuo quântico' },
  { code: 'M261', title: 'Laboratório de Engenharia de Campo', emoji: '🔧', route: '/module-261', category: 'mid', description: 'Projeto de ressonadores e guias de onda' },
  ...
  { code: 'M351', title: 'Meta-materiais & Óptica Quântica (4D+)', emoji: '👁️', route: '/module-351', category: 'mid', description: 'Criação de lentes quânticas' },
  { code: 'M361', title: 'Psicologia Quântica (5D)', emoji: '❤️', route: '/module-361', category: 'mid', description: 'Estudo da empatia e consciência coletiva' },
