...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M306', emoji: '🧪', title: 'Laboratório de Ressonância', route: '/module-306', category: 'mid', description: 'Espaço interativo para aplicar equações, invocar frequências e observar transformações em tempo real.' },
