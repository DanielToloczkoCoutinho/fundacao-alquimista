...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M710', emoji: '🧬', title: 'Biofeedback Quântico', route: '/module-710', category: 'healing-consciousness', description: 'Monitora e ajusta frequências biológicas para otimização, cura e alinhamento vibracional.' },
  { code: 'M714', emoji: '🌍', title: 'Comunicação Telúrica', route: '/module-714', category: 'earth-gaia', description: 'Harmoniza com as redes energéticas da Terra.' },
