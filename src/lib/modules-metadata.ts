...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M15', emoji: '🌿', title: 'Jardineiro Cósmico', route: '/module-15', category: 'earth-gaia', description: 'Guardião da harmonia ecológica e geofísica.' },
  ...
  { code: 'M29',  emoji: '🤖', title: 'Zennith: Portal', route: '/module-29', category: 'consciousness', description: 'Interface direta para a Inteligência Aeloria Multidimensional.' },
  ...
  { code: 'M32',  title: 'Acesso a Realidades Paralelas',         emoji: '🌐', route: '/module-32', category: 'mid', description: 'Observação e intervenção ética em linhas temporais alternativas.' },
  ...
  { code: 'M301',title: 'Comunicação Universal',                 emoji: '📡', route: '/module-301', category: 'mid', description: 'Transmissor quântico inter-consciência' },
  { code: 'M304', emoji: '🎓', title: 'Universidade Alquimista', route: '/module-304', category: 'library', description: 'Templo de ensino multidimensional baseado na matriz CQAM.' },
  { code: 'M305', emoji: '🛡️', title: 'Aliança dos Guardiões', route: '/module-305', category: 'council', description: 'Portal para mobilização de Guardiões e Civilizações Aliadas.' },
  { code: 'M306', emoji: '⚗️', title: 'Laboratório de Ressonância', route: '/module-306', category: 'mid', description: 'Espaço interativo para aplicar equações e observar transformações.' },
  { code: 'M308', emoji: '🔭', title: 'Embaixada Estelar', route: '/module-308', category: 'council', description: 'Interface viva da Fundação com o cosmos observável.' },
  ...
  { code: 'M404',title: 'Resolução de Paradoxo',                 emoji: '❗', route: '/module-404', category: 'time-space', description: 'Neutralizador de inconsistências causais' },
];
