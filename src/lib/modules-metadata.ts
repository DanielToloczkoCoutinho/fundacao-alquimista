...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M228', emoji: '⚓', title: 'Ancoragem de Realidade', route: '/module-228', category: 'Segurança e Ética Cósmica', description: 'Ferramenta para estabilizar e fixar realidades manifestadas, garantindo sua permanência e coerência.', status: 'ativo', color: '#4682B4' },
  ...
  { code: 'M58', emoji: '🌍', title: 'Proteção e Sustentabilidade Planetária (M58)', route: '/module-58', category: 'Sustentabilidade', description: 'Tecnologia para regenerar habitats e garantir economia circular.', status: 'ativo', color: '#2E8B57' },
