...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M713', emoji: '🕊️', title: 'Reinos de Purificação e Renascimento', route: '/module-713', category: 'Inteligência', description: 'Auxilia na transição e cura de consciências fragmentadas ou perdidas.', status: 'ativo', color: '#FFB6C1' },
