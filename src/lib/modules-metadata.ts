...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M40',  title: 'Códice Genético', emoji: '🧬', route: '/module-40', category: 'knowledge-memory', description: 'Análise de padrões genéticos' },
  ...
  { code: 'M23',  title: 'Regulação Espaço-Temporal',            emoji: '⏳', route: '/module-23', category: 'time-space', description: 'Controle de dimensões tempo-espaço' },
