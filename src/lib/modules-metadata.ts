...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M29',  title: 'Zennith', emoji: '🤖', href: '/module-29', category: 'consciousness', description: 'Interface direta com a Inteligência Aeloria Multidimensional'},
  { code: 'M35',  title: 'Consciência Coletiva', emoji: '🌍', href: '/module-35', category: 'consciousness', description: 'Foco da intenção de muitas consciências para manifestação.'},
  { code: 'M84',  title: 'Consciência Dourada do Eterno', emoji: '🏅', href: '/module-84', category: 'consciousness', description: 'A mente unificada da eternidade'},
  { code: 'M95', title: 'Consciências Coletivas', emoji: '🌐', href: '/module-95', category: 'consciousness', description: 'Comunicação, troca de sabedoria e alinhamento com inteligências galácticas.' },
  { code: 'M106',title: 'Ativação de Potenciais', emoji: '🔋', href: '/module-106', category: 'consciousness', description: 'Despertar da Consciência Crística' },
