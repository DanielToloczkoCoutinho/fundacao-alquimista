...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M100',title: 'Unificação Energética',                 emoji: '🔋', href: '/module-100', category: 'mid' },
  { code: 'M101',title: 'Manifestação',                          emoji: '✨', href: '/module-101', category: 'mid' },
  { code: 'M102',title: 'Campos Morfogenéticos',                 emoji: '🌀', href: '/module-102', category: 'mid' },
  { code: 'M103',title: 'Modulação Local',                       emoji: '🎚️', href: '/module-103', category: 'mid' },
  { code: 'M104',title: 'Engenharia do Espaço-Tempo',            emoji: '🕰️', href: '/module-104', category: 'mid' },
  { code: 'M105',title: 'Conexão com a Fonte',                   emoji: '🌌', href: '/module-105', category: 'mid' },
  { code: 'M106',title: 'Ativação de Potenciais',                emoji: '🔋', href: '/module-106', category: 'mid' },
  { code: 'M107',title: 'Restauração Temporal',                  emoji: '⏳', href: '/module-107', category: 'mid' },
  { code: 'M108',title: 'Harmonização de Realidades',            emoji: '🎭', href: '/module-108', category: 'mid' },
  { code: 'M109',title: 'Cura Quântica',                         emoji: '🩹', href: '/module-109', category: 'mid' },
  { code: 'M110',title: 'Co-Criação',                            emoji: '🤲', href: '/module-110', category: 'mid' },
  { code: 'M112',title: 'Solarian Domus',                        emoji: '🏠', href: '/module-112', category: 'mid' },
  { code: 'M113',title: 'Rede Aurora Cristalina',                emoji: '🌈', href: '/module-113', category: 'mid' },
  { code: 'M114',title: 'Prisma da Manifestação',                emoji: '🔶', href: '/module-114', category: 'mid' },
  { code: 'M115',title: 'Matriz de Ressonância',                 emoji: '📊', href: '/module-115', category: 'mid' },
  { code: 'M116',title: 'Portais Quânticos',                     emoji: '🚪', href: '/module-116', category: 'mid' },
  { code: 'M117',title: 'Flor do Éter',                          emoji: '🌸', href: '/module-117', category: 'mid' },
  { code: 'M118',title: 'Luz Primordial',                        emoji: '💡', href: '/module-118', category: 'mid' },
  { code: 'M301',title: 'Comunicação Universal',                 emoji: '📡', href: '/module-301', category: 'mid' },
  { code: 'M302',title: 'Frequência do Amor',                    emoji: '💖', href: '/module-302', category: 'mid' },
