...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M171', emoji: '👽', title: 'Laboratório de Astrobiologia', route: '/module-171', category: 'Laboratórios e Pesquisa', description: 'Simula atmosferas e ecossistemas de exoplanetas.', status: 'ativo', color: '#20B2AA' },
  { code: 'M221', emoji: '〰️', title: 'Observatório de Ondas Gravitacionais', route: '/module-221', category: 'Laboratórios e Pesquisa', description: 'Detecta as ondulações no tecido do espaço-tempo.', status: 'ativo', color: '#20B2AA' },
  { code: 'M241', emoji: '🧠', title: 'Laboratório de Consciência Quântica', route: '/module-241', category: 'Laboratórios e Pesquisa', description: 'Estuda o emaranhamento como base da consciência e telepatia.', status: 'ativo', color: '#20B2AA' },
  ...
  { code: 'M251', emoji: '⚡', title: 'Laboratório de Energia do Ponto Zero', route: '/module-251', category: 'Laboratórios e Pesquisa', description: 'Extrai e estabiliza a energia do vácuo quântico.', status: 'ativo', color: '#20B2AA' },
  { code: 'M311', emoji: '🧠', title: 'Neuroengenharia e Interfaces (6D)', route: '/module-311', category: 'Laboratórios e Pesquisa', description: 'Desenvolve interfaces cérebro-computador quântico-híbridas.', status: 'ativo', color: '#20B2AA' },
  { code: 'M331', emoji: '🤖', title: 'Laboratórios de Criatividade e Inovação', route: '/module-331', category: 'Laboratórios e Pesquisa', description: 'Desenvolve sistemas auto-organizados que co-evoluem e criam novas estratégias.', status: 'ativo', color: '#20B2AA' },
  ...
  { code: 'M63', emoji: '🍲', title: 'Nutrição Universal', route: '/module-63', category: 'Bem-estar e Saúde Universal', description: 'Garante nutrição balanceada e regenerativa para todas as formas de vida.', status: 'ativo', color: '#FF69B4' },
