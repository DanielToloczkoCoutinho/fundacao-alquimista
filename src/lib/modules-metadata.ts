...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M18', emoji: '🔮', title: 'Orquestração Akáshica',                 emoji: '🔮', route: '/module-18', category: 'mid', description: 'Coordenação de registros universais' },
  { code: 'M19', emoji: '🛡️‍', title: 'Análise de Campos de Força',            emoji: '🛡️‍', route: '/module-19', category: 'mid', description: 'Estudo de barreiras energéticas' },
  { code: 'M20', emoji: '🔥', title: 'Orquestrador Elemental',               emoji: '🔥', route: '/module-20', category: 'mid', description: 'Controle dos elementos fundamentais' },
  { code: 'M21', emoji: '🚀', title: 'Navegação Interdimensional',           emoji: '🚀', route: '/module-21', category: 'mid', description: 'Travessia entre dimensões' },
  { code: 'M22', emoji: '🕶️', title: 'Motor da Realidade Quântica',                  emoji: '🕶️', route: '/module-22', category: 'mid', description: 'Geração de realidades alternativas' },
  { code: 'M23', emoji: '⏳', title: 'Regulação Espaço-Temporal',            emoji: '⏳', route: '/module-23', category: 'mid', description: 'Controle de dimensões tempo-espaço' },
  { code: 'M24', emoji: '🎶', title: 'Alinhamento da Sinfonia Pessoal',       emoji: '🎶', route: '/module-24', category: 'mid', description: 'Sincronização de propósito individual' },
  { code: 'M25', emoji: '👁️', title: 'Projeção de Consciência',              emoji: '👁️', route: '/module-25', category: 'mid', description: 'Expansão da awareness além do corporal' },
  { code: 'M26', emoji: '🛂', title: 'Supervisão de Travessias',                  emoji: '🛂', route: '/module-26', category: 'mid', description: 'Monitoramento de jornadas dimensionais' },
  { code: 'M27', emoji: '📠', title: 'Síntese e Replicação Cósmica',     emoji: '📠', route: '/module-27', category: 'mid', description: 'Criação de materiais e estruturas' },
  { code: 'M28', emoji: '🌊', title: 'Harmonização Vibracional',             emoji: '🌊', route: '/module-28', category: 'mid', description: 'Balanceamento de frequências' },
  { code: 'M30', emoji: '🚨', title: 'Detecção de Ameaças',                  emoji: '🚨', route: '/module-30', category: 'mid', description: 'Identificação de perigos multidimensionais' },
  { code: 'M31', emoji: '✍️', title: 'Manipulação da Realidade',              emoji: '✍️', route: '/module-31', category: 'mid', description: 'Modificação consciente do existente' },
  { code: 'M32', emoji: '🌐', title: 'Acesso a Realidades Paralelas',         emoji: '🌐', route: '/module-32', category: 'mid', description: 'Conexão com dimensões alternativas' },
  { code: 'M33', emoji: '🗣️', title: 'Diretrizes do Observador Divino',      emoji: '🗣️', route: '/module-33', category: 'mid', description: 'Orientações de entidades superiores' },
  { code: 'M34', emoji: '🎼', title: 'Orquestração Central',                 emoji: '🎼', route: '/module-34', category: 'mid', description: 'Coordenação de todos os sistemas' },
  { code: 'M35', emoji: '🙌', title: 'Consciência Coletiva',                  emoji: '🙌', route: '/module-35', category: 'mid', description: 'Rede de mentes interconectadas' },
  { code: 'M36', emoji: '🕰️', title: 'Engenharia Temporal',                emoji: '🕰️', route: '/module-36', category: 'mid', description: 'Manipulação de linhas do tempo' },
  { code: 'M37', emoji: '🌬️', title: 'Ajuste de Fluxo Temporal',               emoji: '🌬️', route: '/module-37', category: 'mid', description: 'Modulação do curso temporal' },
  { code: 'M38', emoji: '☀️', title: 'Previsão de Ciclos Solares',            emoji: '☀️', route: '/module-38', category: 'mid', description: 'Antecipação de atividades estelares' },
  { code: 'M39', emoji: '📖', title: 'Códice Vivo da Ascensão',               emoji: '📖', route: '/module-39', category: 'mid', description: 'Registro evolutivo dinâmico' },
  { code: 'M40', emoji: '🧬', title: 'Códice Genético Multidimensional',      emoji: '🧬', route: '/module-40', category: 'mid', description: 'Mapa da expressão genética expandida' },
  { code: 'M41', emoji: '🔬', title: 'Laboratório de Coerência Quântica',     emoji: '🔬', route: '/module-41', category: 'mid', description: 'Experimentos com estados quânticos' },
  { code: 'M42', emoji: '📚', title: 'ChronoCodex Unificado',                 emoji: '📚', route: '/module-42', category: 'mid', description: 'Integração de registros temporais' },
  { code: 'M43', emoji: '🪐', title: 'Orquestração do Sistema Solar',         emoji: '🪐', route: '/module-43', category: 'mid', description: 'Coordenação de corpos celestes' },
