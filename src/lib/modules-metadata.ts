...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M10', emoji: '🛡️', title: 'Oráculo da Tapeçaria', route: '/module-10', category: 'Segurança e Ética Cósmica', description: 'Defesa avançada e neutralização de ameaças complexas.', connections: [{source: 'M10', target:'M30', type: 'dependencia', label: 'detecta'}, {source: 'M10', target:'M141', type: 'influencia', label: 'audita'}], color: '#FF6B6B', status: 'ativo' },
  { code: 'M30', title: 'Detecção de Ameaças', emoji: '🚨', route: '/module-30', category: 'Segurança e Ética Cósmica', description: 'Radar cósmico para ameaças e dissonâncias.', connections: [{source: 'M30', target:'M10', type: 'retorno-inteligente', label: 'alerta'}, {source: 'M30', target:'M1', type: 'dependencia', label: 'protocolo'}], color: '#FF6B6B', status: 'ativo' },
  ...
  { code: 'M57', emoji: '🔒', title: 'Segurança e Privacidade', route: '/module-57', category: 'Segurança e Ética Cósmica', description: 'Cofre quântico para comunicações invioláveis.', connections: [{source: 'M57', target:'M55', type: 'protecao', label: 'protege'}, {source: 'M57', target:'M1', type: 'dependencia', label: 'protocolo'}], color: '#FF6B6B', status: 'ativo' },
  { code: 'M68', emoji: '🛡️', title: 'Responsabilidade Ética', route: '/module-68', category: 'Segurança e Ética Cósmica', description: 'Diretrizes para o uso benéfico da tecnologia.', connections: [{source: 'M68', target:'M144', type: 'heranca', label: 'princípio'}, {source: 'M68', target:'M67', type: 'influencia', label: 'guia'}], color: '#FF6B6B', status: 'ativo' },
  ...
  // 3. Governança
  { code: 'M45', title: 'CONCILIVM', emoji: '🏛️', route: '/module-45', category: 'Governança', description: 'Câmara para deliberações cósmicas.', connections: [{source: 'M45', target:'M600', type: 'dependencia', label: 'sede'}, {source: 'M45', target:'M144', type: 'influencia', label: 'decreta'}], color: '#4ECDC4', status: 'ativo' },
  ...
  { code: 'M11', emoji: '🚪', title: 'Gerenciamento de Portais', route: '/module-11', category: 'Consciência e Expansão Dimensional', description: 'Engenharia de pontes entre mundos.', connections: [{source: 'M11', target:'M1', type: 'protecao', label: 'segurança'}, {source: 'M11', target:'M116', type: 'dependencia', label: 'ativa'}], color: '#7B61FF', status: 'ativo' },
  { code: 'M12', title: 'Arquivo Akáshico', emoji: '🗄️', route: '/module-12', category: 'Bibliotecas e Arquivos Sagrados', description: 'Repositório de conhecimento universal.', connections: [{source: 'M12', target:'M18', type: 'dependencia', label: 'orquestra'}, {source: 'M12', target:'M310', type: 'heranca', label: 'origem'}], color: '#FFE66D', status: 'ativo' },
  { code: 'M13', emoji: '🎶', title: 'Mapeamento de Frequências', route: '/module-13', category: 'Laboratórios e Pesquisa', description: 'Diagnóstico de saúde vibracional.', connections: [{source: 'M13', target:'M28', type: 'retorno-inteligente', label: 'diagnostica'}, {source: 'M13', target:'M115', type: 'influencia', label: 'mapeia'}], color: '#4ECDC4', status: 'ativo' },
  { code: 'M14', emoji: '⚛️', title: 'Transmutador Quântico', route: '/module-14', category: 'Realidade Quântica & Engenharia Cósmica', description: 'Converte energia em matéria e sustenta a manifestação.', connections: [{source: 'M14', target:'M307', type: 'dependencia', label: 'reforça'}, {source: 'M14', target:'M90', type: 'retorno-inteligente', label: 'gera'}], color: '#FF6F61', status: 'ativo' },
  { code: 'M15', emoji: '🌦️', title: 'Jardineiro Cósmico', route: '/module-15', category: 'Sustentabilidade e Ecossistemas', description: 'Monitora e intervém eticamente em sistemas climáticos.', connections: [{source: 'M15', target:'M94', type: 'influencia', label: 'guia'}, {source: 'M15', target:'M117', type: 'dependencia', label: 'orquestra'}], color: '#6BFF6B', status: 'ativo' },
  { code: 'M16', emoji: '🌱', title: 'Bio-Sustentabilidade', route: '/module-16', category: 'Sustentabilidade e Ecossistemas', description: 'Biossíntese de ecossistemas artificiais e autossustentáveis.', connections: [{source: 'M16', target:'M94', type: 'dependencia', label: 'blueprint'}, {source: 'M16', target:'M15', type: 'heranca', label: 'mantém'}], color: '#6BFF6B', status: 'ativo' },
  ...
  { code: 'M18', title: 'Orquestração Akáshica', emoji: '🎼', route: '/module-18', category: 'Bibliotecas e Arquivos Sagrados', description: 'Coordenação de registros universais.', connections: [{source: 'M18', target:'M12', type: 'dependencia', label: 'acessa'}, {source: 'M18', target:'M29', type: 'retorno-inteligente', label: 'sintetiza'}], color: '#FFE66D', status: 'ativo' },
