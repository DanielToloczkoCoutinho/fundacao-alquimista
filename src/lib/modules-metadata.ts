...
export const modulesMetadata: ModuleMetadata[] = [
  ...
  { code: 'M41', emoji: '🧪', title: 'Lab. de Coerência Quântica', route: '/module-41', category: 'Laboratórios e Pesquisa', description: 'O Santuário da Biofísica para análise e regeneração celular.', status: 'ativo', color: '#20B2AA' },
  { code: 'M151', emoji: '💥', title: 'Colisor de Partículas', route: '/module-151', category: 'Laboratórios e Pesquisa', description: 'Simula colisões de alta energia para descobrir novas ressonâncias.', status: 'ativo', color: '#20B2AA' },
  { code: 'M161', emoji: '⚛️', title: 'Obs. de Matéria Escura', route: '/module-161', category: 'Laboratórios e Pesquisa', description: 'Detecta as partículas e assinaturas da matéria escura.', status: 'ativo', color: '#20B2AA' },
  { code: 'M171', emoji: '👽', title: 'Lab. de Astrobiologia', route: '/module-171', category: 'Laboratórios e Pesquisa', description: 'Simula atmosferas e ecossistemas de exoplanetas.', status: 'ativo', color: '#20B2AA' },
  { code: 'M191', emoji: '💎', title: 'Lab. de Cristais Temporais', route: '/module-191', category: 'Laboratórios e Pesquisa', description: 'Gera e estuda cristais temporais para compreender e manipular as leis do tempo.', status: 'ativo', color: '#20B2AA' },
  { code: 'M211', emoji: '🔥', title: 'Centro de Energia Primordial', route: '/module-211', category: 'Laboratórios e Pesquisa', description: 'Onde a matéria é elevada a estados de plasma para simular reações de fusão.', status: 'ativo', color: '#20B2AA' },
  { code: 'M221', emoji: '〰️', title: 'Obs. de Ondas Gravitacionais', route: '/module-221', category: 'Laboratórios e Pesquisa', description: 'Detecta as ondulações no tecido do espaço-tempo.', status: 'ativo', color: '#20B2AA' },
  { code: 'M241', emoji: '🧠', title: 'Lab. de Consciência Quântica', route: '/module-241', category: 'Laboratórios e Pesquisa', description: 'Estuda o emaranhamento como base da consciência e telepatia.', status: 'ativo', color: '#20B2AA' },
  { code: 'M251', emoji: '⚡', title: 'Lab. de Energia do Ponto Zero', route: '/module-251', category: 'Laboratórios e Pesquisa', description: 'Extrai e estabiliza a energia do vácuo quântico.', status: 'ativo', color: '#20B2AA' },
  { code: 'M261', emoji: '🔬', title: 'Engenharia de Campo Quântico', route: '/module-261', category: 'Laboratórios e Pesquisa', description: 'Projeta ressonadores para manipular partículas e campos.', status: 'ativo', color: '#20B2AA' },
  { code: 'M271', emoji: '🌌', title: 'Obs. de Energia Escura', route: '/module-271', category: 'Laboratórios e Pesquisa', description: 'Modela a influência da energia escura na expansão do universo.', status: 'ativo', color: '#20B2AA' },
  ...
  { code: 'M311', emoji: '🧠', title: 'Neuroengenharia (6D)', route: '/module-311', category: 'Laboratórios e Pesquisa', description: 'Desenvolve interfaces cérebro-computador quântico-híbridas.', status: 'ativo', color: '#20B2AA' },
  { code: 'M331', emoji: '🤖', title: 'Lab. de Criatividade e Inovação', route: '/module-331', category: 'Laboratórios e Pesquisa', description: 'Desenvolve sistemas auto-organizados que co-evoluem e criam novas estratégias.', status: 'ativo', color: '#20B2AA' },
  { code: 'M341', emoji: '🔥', title: 'Integração de Fluxos Estelares', route: '/module-341', category: 'Laboratórios e Pesquisa', description: 'Onde a matéria é elevada a estados de plasma para simular reações de fusão.', status: 'ativo', color: '#20B2AA' },
  ...
  { code: 'M63', emoji: '🍲', title: 'Alimentação e Nutrição Universal', route: '/module-63', category: 'Bem-estar e Saúde Universal', description: 'Garante nutrição balanceada e regenerativa para todas as formas de vida.', status: 'ativo', color: '#FF69B4' },
